...
<body class="main has-navbar-fixed-top">
  ...
  <section class="hero feature one4-feature is-large fadeIn">
    <div class="hero-body">
      <div class="container">
        <h1 class="title has-text-white heavy shadow">Amelanderkaap 4 People</h1>
      </div>
    </div>
  </section>
      ...
      <div class="columns">
        <div class="column is-8">
          <div class="content">
            ...
            <p>Heeft u ook zin in een welverdiende vakantie? Dan is dit appartement op Ameland de ideale bestemming voor uw vakantie. Een modern 3 kamerappartement op de eerste verdieping, met vrij uitzicht, geschikt voor 5 personen. Het appartement beschikt over 2 slaapkamers waarvan 1 met 2 eenpersoonsbedden en 1 met een stapelbed en een eenpersoonsbed. Daarnaast is er een badkamer met ligbad en wc. De keuken is voorzien van een combi magnetron , een vaatwasser en een koffiezetapparaat. Het appartement is voorzien van een schuifdeur naar het balkon. Vanaf het balkon heeft u vrij uitzicht.  De auto kan geparkeerd worden naast het appartementencomplex.</p>
          </div>
        </div>
