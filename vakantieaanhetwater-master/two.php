...
<body class="main has-navbar-fixed-top">
  ...
  <section class="hero feature two-feature is-large fadeIn">
    <div class="hero-body">
      <div class="container">
        <h1 class="title has-text-white heavy shadow">Boomhiemke</h1>
      </div>
    </div>
  </section>
      ...
      <div class="columns is-mobile is-multiline huts">
        ...
        <div class="column is-6-desktop is-12-touch">
          <div class="content about">
            <a href="./two2"><p><span class="about-title heavy">2 PEOPLE</span><br>Cras augue dolor, blandit eu consectetur at, venenatis at sem. Pellentesque at dui dolor. Morbi molestie lacus in ante auctor, nec maximus tellus elementum. Pellentesque justo nulla,
        ...
        <div class="column is-6-desktop is-12-touch">
          <div class="content about has-text-right-desktop">
            <a href="./two4"><p><span class="about-title heavy">4 PEOPLE</span><br>Cras augue dolor, blandit eu consectetur at, venenatis at sem. Pellentesque at dui dolor. Morbi molestie lacus in ante auctor, nec maximus tellus elementum. Pellentesque justo nulla,
              posuere eget elementum vel, egestas non sapien. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p><a>
          </div>
        </div>
